...
export default function Class2English() {
  const [heroState, setHeroState] = useState(
    localStorage.getItem("heroStateClass2English"),
  );
  ...
  useEffect(() => {
    const getClass1MathsData = async () => {
      let url = `http://localhost:8000/api/class2/english`;
  ...
  useEffect(() => {
    localStorage.setItem("heroStateClass2English", heroState);
  });
