...
export default function Class2Maths() {
  const [heroState, setHeroState] = useState(
    localStorage.getItem("heroStateClass2Maths"),
  );
  ...
  useEffect(() => {
    const getClass1MathsData = async () => {
      let url = `http://localhost:8000/api/class2/maths`;
  ...
  useEffect(() => {
    localStorage.setItem("heroStateClass2Maths", heroState);
  });
